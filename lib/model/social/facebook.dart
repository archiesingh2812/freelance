...
class FaceBookLogin {
  ...
  Future<Null> login(
      Function(String type, String id, String name, String photo) callback,
  ...
  _loginok(
      ...
      Function(String type, String id, String name, String photo)
          callback) async {
    dprint("Facebook login: token: ${accessToken.token}");
    dprint("Facebook login: userId: ${accessToken.userId}");
    var response = await http.get(Uri.parse(
        'https://graph.facebook.com/me?fields=name,first_name,last_name,email&access_token=${accessToken.token}'));
    ...
    var _photo =
        'https://graph.facebook.com/${accessToken.userId}/picture?type=square';
