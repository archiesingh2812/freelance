...
class _DishesDetailsScreenState extends State<DishesDetailsScreen>
  ...
  void initState() {
    ...
    _tabController =
        TabController(vsync: this, length: _this.imagesFiles.length + 1);
        ...
        body: Directionality(
          ...
          child: Stack(children: [
            ...
            skinHeaderBackButtonWithBasket(
                context, mainScreenState.onBack, Colors.black),
          ]),
        ));
  }
          ...
          children: [
            Expanded(
              child: ListWithIcon(
                ...
                text: "${_this.name} $_addedName", // dish name
    ...
    if (_this.ingredients.isNotEmpty) {
      list.add(Container(
        ...
        child: ListWithIcon(
            ...
            text: strings.get(79), // Ingredients
            imageColor: theme.colorDefaultText),
      ));
      list.add(SizedBox(
        height: 20,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _edit(editControllerReview, strings.get(141),
                  false), //  "Enter your review",
              SizedBox(
                height: 30,
              ),
              Container(
