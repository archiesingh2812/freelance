...
Container(
  ...
  child: skinHeaderMenu(context, onBack, _headerText),
      ...
      if (appSettings.bottomBarType == "type1" && theme.appSkin == "basic")
          IBottomBar(colorBackground: appSettings.bottomBarColor, colorSelect: Colors.yellow.shade800,
                colorUnSelect: Colors.yellow.shade800, callback: _bottonBarChange, initialSelect: _currentPage,
      ...
      if (appSettings.bottomBarType == "type2" && theme.appSkin == "basic")
          IBottomBar2(colorBackground: Colors.yellow, colorSelect: theme.colorPrimary,
              colorUnSelect: Colors.yellow.shade800, callback: _bottonBarChange, initialSelect: _currentPage,
