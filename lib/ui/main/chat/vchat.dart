...
import 'package:fooddelivery/widget/ibackground-noimage.dart';
...
class _VendorChatScreenState extends State<VendorChatScreen> {
    ...
    child: Scaffold(
        ...
        Stack(
          children: <Widget>[
            ...
            IBackgroundNoimage(width: windowWidth, colorsGradient: colorsGradient),
        ...
        if (_state == "view")
          Align(
            ...
            child: Container(
              ...
              child: InputFieldArea3(hint: "Mensagem", callback: onSendText,
  ...
  _body2(){
    ...
    for (var _data in _this) {
      ...
      var createdAt = formatter.format(DateTime.parse(_data.date));
      var now ="$createdAt";
      if (now != last) {
