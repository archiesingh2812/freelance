...
buttonAddToCart(
    DishesData item, Function redraw, Function onCancel, var _scaffoldKey) {
  _onMinusClick() {
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: new BorderRadius.only(
                      topLeft: Radius.circular(
                          MediaQuery.of(mainContext).size.width * 0.08)),
                ),
                ...
                children: <Widget>[
                  Flexible(
                    child: IButton3(
                        ...
                        pressButton: () {
                          dprint(
                              "User pressed \"Add to cart\" button. Count = ${item.count}");
                          if (!account.isAuth())
                          ...
                          if (basket.restaurantCheck(item.restaurant)) {
                            ...
                            _openResetDishesDialog(
                                _scaffoldKey, item, onCancel);
                          }
                        }),
                  ),
                  Flexible(
                      child: FittedBox(
                    child: Text(
                      basket.makePriceString(basket.getItemPrice(item)),
                      style: TextStyle(
                        color: Colors.white,
