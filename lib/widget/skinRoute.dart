  ...
  if (theme.appSkin == "basic") {
    ...
    switch (id) {
      case 1:
        ...
        break;
      case 3:
        imageAsset = "assets/addtocart.png";
        break;
...
skinHeaderBackButtonWithBasket(
  ...
  if (theme.appSkin == "basic")
    return bHeaderBackButtonWithBasket(context, callback, Colors.black);
  if (theme.appSkin == "smarter")
    return sHeaderBackButtonWithBasket(context, callback, Colors.black);
}
